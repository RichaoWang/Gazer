...
// 2024-04-28 13:14:32.498654400 UTC
    ...
    namespace schemas {
        ...
        namespace server_dll {
            ...
            namespace CDynamicProp {
                ...
                constexpr std::ptrdiff_t m_glowColor = 0xB58; // 
            ...
            namespace CPhysicsProp {
                ...
                constexpr std::ptrdiff_t m_glowColor = 0xBB4; // 
            ...
            namespace CCSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_GunGameImmunityColor = 0x195C; // 
